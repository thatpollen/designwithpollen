...
export default function Hero() {
  return (
    <section id="hero">
      <div className="flex flex-col justify-center items-stretch pt-32 pb-[200px] h-[90vh] relative text-white border-b border-[rgba(255,255,255,0.08)] overflow-hidden md:pb-32 md:h-auto xs:py-20">
